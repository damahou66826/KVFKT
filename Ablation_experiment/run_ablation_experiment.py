...
ablation_classes = ['D', 'F', 'G', 'IRT']
datasets = ['EdNet', 'assist2017','assist2012', 'Junyi', 'fsai','NeurIPS']
# datasets = ['NeurIPS']
...
for ablation_class in ablation_classes:
    for model_profile in model_profiles:
        # base
        command = ["python", 'ablation_main.py']
        ...
        # add ablation_experiment parameter
        command.append("--ablation_experiment_parameter")
        command.append("{}".format(ablation_class))
