...
# set logger
logger = getLogger('KVFKTModelExcludeDifficult')
...
class KVFKTModelExcludeDifficult(object):
    '''
    Key-Memory-Forget Knowledge Trace
    '''

    def __init__(self, args, sess, name="KVFKTModelExcludeDifficult"):
        self.args = args
        self.sess = sess
        self.name = name
        self.create_model()
    ...
    def _influence(self):
        ...
        for i in range(self.args.seq_len):
            ...
            # Prediction
            pred_z_value = 3.0 * student_ability
